...
namespace TestProject1
{
    ...
    //        var meeting = new Meeting(DateTime.Parse("6:30"), DateTime.Parse("7:30"));
    ...
    //    }
    //    [TestMethod]
    //    public void CanAddMeetingTest_True_6()
    //    {
    //        DataSetters dh = new DataSetters();
    //        var worker = new Worker();
    //        worker.WorkingHours = new WorkingHours(DateTime.Parse("10:00"),
    //                                   DateTime.Parse("18:30"));

    //        worker.Meetings = new List<Meeting>
    //        {
    //             new Meeting(DateTime.Parse("10:00"), DateTime.Parse("10:30")),
    //             new Meeting(DateTime.Parse("10:30"), DateTime.Parse("11:30")),
    //             new Meeting(DateTime.Parse("12:00"), DateTime.Parse("13:00")),
    //             new Meeting(DateTime.Parse("13:00"), DateTime.Parse("14:30")),
    //             new Meeting(DateTime.Parse("14:30"), DateTime.Parse("15:00")),
    //             new Meeting(DateTime.Parse("16:00"), DateTime.Parse("18:00"))
    //        };

    //        var meeting = new Meeting(DateTime.Parse("18:00"), DateTime.Parse("18:30"));
    ...
    //    }
    //    [TestMethod]
    //    public void CanAddMeetingTest_False_7()
    //    {
    //        DataSetters dh = new DataSetters();
    //        var worker = new Worker();
    //        worker.WorkingHours = new WorkingHours(DateTime.Parse("10:00"),
    ...
    //        var meeting = new Meeting(DateTime.Parse("10:30"), DateTime.Parse("11:00"));
